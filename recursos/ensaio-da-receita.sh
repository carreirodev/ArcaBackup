...
echo "As duas receitas nao dividem o mesmo arca-fim.txt"
preparar 0 0; executar "$BACKUP"; executar "$RESTAURACAO"
conferir "backup sobreviveu a restauracao" "$FIM_BACKUP" ARCA_SELO=a3f1c9e07b2d4856 ARCA_BACKUP=OK ARCA_FIM
